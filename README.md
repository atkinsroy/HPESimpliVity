...
Supports the new features in HPE SimpliVity 4.0.0. Specifically, the ability to add and show external store (HPE StoreOnce is currently supported) and the ability to backup to external stores. Refer to the ![Release Notes](/RELEASENOTES.md) for more details
